...
class TableController extends Controller
{
    ...
    /**
     * Update a single row in a table (identified by primary key).
     */
    ...
    /**
     * Delete a single row from a table (identified by primary key).
     */
    ...
    /**
     * Return the primary key column name for a table, or null.
     */
